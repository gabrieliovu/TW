...
class Comanda_teme {
    public function functionTeme() {
        ...
        $query= "select cantitate from produse where denumire='teme'";
        ...
        Comenzi::comanda('teme');
        $query1="update produse set cantitate=cantitate-1 where denumire='teme'";
